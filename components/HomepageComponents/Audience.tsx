    ...
    <div className='w-9/12 lg:h-screen mx-auto flex flex-col lg:flex-row my-16 lg:my-0 lg:space-x-16'>
        ...
        <div className='lg:w-8/12 lg:h-[70%] py-4'>
            <div className='lg:my-10 lg:w-9/12'>
                ...
                <p className='text-grayText font-light leading-6'>Starting out in Abuja, we want to reach the right people.</p>
            </div>
            <div className='flex flex-col space-y-6 mt-6 md:mt-0'>
              <div className='flex flex-col md:flex-row space-y-6 md:space-y-0 '>
                <div className='md:mr-8 '>
                  ...
                  <p className='text-sm text-grayText font-light leading-6'>Project 774 aims to spark interest and curiosity across all local governments of the Nigerian society.</p>
                </div>
                <div className='md:mr-8'>
